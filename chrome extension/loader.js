...
function inject(data, window) 
{
	loadScript( getUrl( data.url ), false, data.url );
};
 ...
 * @param {function} inject(data, window) - data - результат выполнения функции read, window - ready. Выполняет инъекцию скрипта в страницу
