...
vkPatch.plugins.add({	
	...
	aboutPanel: function() 
	{
		...
		return $.nano('<div class="settingsPanel" style="color: #555"><img src="'+this.resources.rabbit+'" style="float: left; margin-bottom: 10px; margin-right: 30px;"><h2 style="color: #555; margin-bottom: 8px; padding-top: 6px;">vkPatch'+debug+'</h2>{version}: '+vkPatch.version+'<br>{homePage}: <a href="http://klinifini.livejournal.com/">http://klinifini.livejournal.com/</a><br>{author}: <a href="http://vkontakte.ru/pochemuto">Сергей Третьяк</a></div>', this.lang);
	}
